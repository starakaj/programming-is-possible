...
You'll find an example implementation of everything that we talk about today in the `meyda-app` directory. You may notice two other directories: `meyda-demo` and `tonetest`. Feel free to ignore these, as they're based on an eariler version of this lesson. Or, check them out. Up to you.
